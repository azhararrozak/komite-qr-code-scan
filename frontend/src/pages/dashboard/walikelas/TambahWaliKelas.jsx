...
import { createWaliKelas } from "../../../services/userService";

const TambahWaliKelas = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    const loadingToast = toast.loading("Membuat user wali kelas...");

    try {
      // eslint-disable-next-line no-unused-vars
      const { confirmPassword, ...dataToSend } = formData;
      await createWaliKelas(dataToSend);
      ...
      toast.dismiss(loadingToast);
      toast.error(
        error.response?.data?.message || "Gagal menambahkan wali kelas",
        {
          duration: 5000,
          position: "top-right",
        }
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-gray-600">
            Buat akun baru untuk wali kelas
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                Masukkan kelas yang akan dipegang oleh wali kelas ini
              </p>
            </div>
...
export default TambahWaliKelas;
