...
const HistoryKelas = () => {
  ...
  const classList = ["7A", "7B", "7C", "7D", "7E", "7F", "7G", "7H", "7I"];
  ...
  const handleSearch = async (e) => {
    ...
    setLoading(true);
    try {
      const data = await getClassPaymentHistory(className);
      setClassData(data);
      ...
      if (data.length === 0) {
        ...
        toast.success(
          `Data kelas ${className} berhasil dimuat (${data.length} siswa)`
        );
      }
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            History Pembayaran Per Kelas
          </h1>
          <p className="text-gray-600">
            Lihat detail riwayat pembayaran semua siswa dalam satu kelas
          </p>
        </div>
        ...
        {!classData && !loading && (
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <p className="text-gray-500">
              Pilih kelas untuk melihat history pembayaran semua siswa
            </p>
          </div>
        )}

        {/* No Data State */}
        {classData && classData.length === 0 && !loading && (
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            <svg
              className="mx-auto h-16 w-16 text-gray-400 mb-4"
              fill="none"
            ...
            <p className="text-gray-500">
              Kelas {className} belum memiliki data siswa
            </p>
          </div>
        )}
      </div>
